...
<body data-target="#nino-navbar" data-spy="scroll">
            ...
            <nav id="nino-navbar" class="navbar navbar-default" role="navigation">
                <div class="container">
                    ...
                    <div class="navbar-header">
                        ...
                        <img src="images/gatestack.png" alt="GateStack - Discussion for GATE CSE" id="site-logo" class="logo-big">
                        </a>
                    </div>
            ...
            <section id="nino-slider" class="carousel slide container" data-ride="carousel">
                ...
                <div class="carousel-inner" role="listbox">
                    <div class="item active">
                        <h2 class="nino-sectionHeading">
                            ...
                            Welcome to GateStack. <br><br>
                            ! Your Unique way to crack Gate ! 
                        </h2>
                    ...
                    <div class="item">
                        ...
                        ! Easy way to grasp the concepts !
			</h2>
                        <a href="javascript:void(0);" class="nino-btn">Learn more</a>
                    </div>
                    <div class="item">
                        <h2 class="nino-sectionHeading">
                    ...
                    <div class="item">
                        ...
                        <a href="javascript:void(0);" class="nino-btn">Start Test</a>
                    </div>
                </div>
                ...
                <ol class="carousel-indicators clearfix">
                    ...
                    <li data-target="#nino-slider" data-slide-to="1">
                        <div class="inner">
                            <span class="number">02</span> Learn
                        </div>
                    </li>
                    <li data-target="#nino-slider" data-slide-to="2">
                        <div class="inner">
                            <span class="number">03</span> Discuss
                        </div>
                    </li>
                    <li data-target="#nino-slider" data-slide-to="3">
                        <div class="inner">
                            <span class="number">04</span> Practice Test
                        </div>
                    </li>
                </ol>
            </section>
    ...
    <section id="nino-story">
        <div class="container">
            ...
            <p class="nino-sectionDesc">Our three way approach for the GATE examination is proved methodology. </p>
            <div class="sectionContent">
                <div class="row nino-hoverEffect">
                    ...
                    <div class="col-md-4 col-sm-4">
                        <div class="item">
                            <a class="overlay" href="https://gatestack.in/" target="_blank">
                                <span class="content">
        ...
        <div class="container">
            <div layout="row" class="verticalStretch">
                ...
                <div class="item">
                    ...
                    <div class="text">Answer Posts</div>
                </div>
                <div class="item">
...
<!--        <div class="container">
    ...
    <section id="nino-happyClient">
        <div class="container">
            <h2 class="nino-sectionHeading">
                <span class="nino-subHeading">Happy Students</span>
                What aspirants say
            </h2>
            <div class="sectionContent">
                <div class="row">
   ...
   <!--  <section id="nino-map">
    ...
    <footer id="footer">
        <div class="container">
                ...
                <div class="col-md-4">
                    <div class="colInfo">
                        <div class="footerLogo">
                            <a href="https://www.gatestack.com" >Gate Stack</a> 
                        </div>
                        <p>
            ...
            <div class="nino-copyright">Copyright &copy; 2017 <a target="_blank" href="http://www.gatestack.com/" title="gatestack.com - Platform for Gate Aspirants on Computer Science &amp; Engineering and Information Technology">Gatestack.com</a>. All Rights Reserved. <br/> </div>
        </div>
    </footer><!--/#footer-->
